            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link head me-5" href="#main-family">Всё для семьи</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link head" href="#main-events">События</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <nav class="menu-mobile">
              <ul class="menu__list-mobile">
                ...
                <form class="d-flex" role="search">
                  <input class="form-control mobile me-2" type="search" placeholder="Поиск по сайту" aria-label="Поиск">
                </form>
